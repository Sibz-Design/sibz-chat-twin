...
<div className="relative z-10">
  <ContainerScroll
    titleComponent={
      <div className="text-center">
        ...
        {/* Description */}
        <p className="text-lg md:text-xl text-foreground/80 mt-6 max-w-2xl mx-auto leading-relaxed">
  ...
  <div className="container mx-auto px-6 pb-16">
    <div className="max-w-4xl mx-auto text-center">
      ...
      {/* Contact Section */}
      <div id="contact-section" className="mt-8 max-w-2xl mx-auto text-left">
